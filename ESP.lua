...
for _,player in pairs(game.Players:GetPlayers()) do
	...
	elseif player.Character:FindFirstChild("HumanoidRootPart") then
		if player.Character.HumanoidRootPart:FindFirstChild("copyBackground") then
			...
			player.Character.HumanoidRootPart:FindFirstChild("copyBackground"):Destroy()
			player.Character.HumanoidRootPart:FindFirstChild("copyBackground2"):Destroy()
			player.Character.HumanoidRootPart:FindFirstChild("copyBackground3"):Destroy()
		end
		if player.Character:FindFirstChild("Head") then
			if player.Team ~= nil then
				...
				elseif player.Team == LP.Team then
					local copyBG = bg:Clone()
					local copyBG2 = bg:Clone()
					local copyBG3 = bg:Clone()
					local copyFrame = frame:Clone()
